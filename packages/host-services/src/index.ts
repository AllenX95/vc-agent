...
export { detectAcademicResearchIntent, detectArxivFulltextIntent, detectFileDownloadIntent, detectMaterialRecallIntent, detectProjectCommandIntent, detectProjectStateRecallIntent, detectTextEditIntent } from "./task-intent.js";
...
export {
  AcademicResearchCache,
  AcademicResearchRunStore,
  AcademicResearchService,
  ArxivAdapter,
  DefaultAcademicHttpAccess,
  GitHubAdapter,
  HuggingFaceAdapter,
  OpenAlexAdapter,
  type AcademicHttpAccess,
  type AcademicPdfExtraction,
  type AcademicPdfExtractor,
  type AcademicPdfSection,
  type AcademicResearchContext,
  type AcademicResearchServiceOptions,
  type AcademicSourceAdapter,
  type AcademicSourceExecutionContext,
  type AcademicSourceResult
} from "./academic-research/academic-research.js";
export {
  academicWorkflowPrototype,
  type AcademicWorkflowPrototype,
  type AcademicWorkflowPrototypeId
} from "./academic-workflows.js";
...
export class CapabilityGateway {
  ...
  #prepare(request: CapabilityExecutionRequest, authorization: CapabilityAuthorizationSnapshot):
    ...
    const context: CapabilityExecutionContext = {
      ...
      ...(authorization.projectRoot === undefined ? {} : { projectRoot: authorization.projectRoot })
    };
