...
export { detectAcademicResearchIntent, detectArxivFulltextIntent, detectFileDownloadIntent, detectMaterialRecallIntent, detectProjectStateRecallIntent, detectTextEditIntent, detectWebResearchIntent } from "./task-intent.js";
