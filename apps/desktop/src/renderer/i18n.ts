...
const zhCN: Record<string, string> = {
  ...
  "This removes the Thread from the project, together with its retained conversation, physical context, queued work, unapproved candidates, and cognition-review source text. Confirmed Memory and Outputs remain.": "这将从项目中删除整个任务，同时清理其对话、物理上下文、排队工作、未确认候选记忆和认知审阅来源；已确认的记忆与输出会保留。",
  "This removes the retained conversation and physical context. Unapproved candidate and cognition-review source text from this task will also be removed. Confirmed Memory and Outputs remain.": "这将删除保留的对话与物理上下文，同时移除本任务中未批准的候选记忆和认知审阅来源；已确认的记忆与输出会保留。",
  "Delete history": "删除历史",
  "Start Investment Reflection": "开始投资复盘",
  "Optional focus": "可选关注点",
  "Reflection Profile": "复盘模型配置",
  "Not assigned": "未分配",
  "Start Reflection": "开始复盘",
  "Confirm Long-term Memory change": "确认长期记忆变更",
  "This is a final confirmation after the Review Bundle. Review the lineage and file diffs before committing.": "这是认知审阅包后的最终确认。提交前请检查来源链路和文件差异。",
  "Discard": "放弃",
  ...
  "Import Skill": "导入技能",
  "Install academic skills": "安装学术研究技能",
